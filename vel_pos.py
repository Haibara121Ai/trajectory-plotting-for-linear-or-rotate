...
def file_name(rotate_way, file_num):
    if rotate_way == "cclw":
        log_files = [
            ("".join([f"{file_num}","_trial","/cclw_120.md"]), "cclw To 120°"),
            ("".join([f"{file_num}","_trial","/cclw_240.md"]), "cclw To 240°"),
            ("".join([f"{file_num}","_trial","/cclw_360.md"]), "cclw To 360°")
        ]
    else :
        log_files = [
            ("".join([f"{file_num}","_trial","/clw_240.md"]), "clw To 240°"),
            ("".join([f"{file_num}","_trial","/clw_120.md"]), "clw To 120°"),
            ("".join([f"{file_num}","_trial","/clw_0.md"]), "clw To 0°")
        ]
